...
1. Reverse the order of that length of elements in the list, starting with the
...
pub fn hash_ops(list: &mut [usize], ops: &[usize], rounds: usize) {
    let mut pos = 0;
    let mut skip = 0;
    for _ in 0..rounds {
